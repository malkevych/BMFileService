#
#  Be sure to run `pod spec lint BMFileServicePod.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/webslesar/BMFileService.git"
  ...
  s.source       = { :git => "https://github.com/webslesar/BMFileService.git", :tag => "#{s.version}" }
